...
| [`List`](List-Type)`<CelestialBody> Children()` | Returns the body's child bodies (ex. Kerbin's child bodies are the Mun and Minmus). |
...
| [`List`](List-Type)`<Biome> Biomes()` | Returns all the biomes for the given celestial body. |
...
| [`List`](List-Type)`<CelestialBody> AllBodies()` | Returns a list of all celestial bodies. |
| [`List`](List-Type)`<CelestialBody> OrbitedBodies()` | Returns a list of all celestial bodies that the player has orbited. |
| [`List`](List-Type)`<CelestialBody> LandedBodies()` | Returns a list of all celestial bodies that the player has landed on. |
