...
namespace ContractConfigurator
{
    ...
    {
        static MethodInfo methodParseSingleValue = typeof(ConfigNodeUtil).GetMethods().Single(m => m.Name == "ParseSingleValue");
        ...
        {
            CelestialBody result = FlightGlobals.Bodies.FirstOrDefault(cb => cb.name == celestialName || string.Equals(cb.CleanDisplayName(), celestialName, StringComparison.InvariantCultureIgnoreCase));
            if (result == null)
            {
